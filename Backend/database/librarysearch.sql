...
(1, 4, 1, '214.3 banc', '222.0 bijb'),
(1, 5, 1, '222.0 offr', '257.2 refo'),
(1, 1, 2, '300.1 mark', '300.6 hand'),
(1, 2, 2, '300.6 onde', '300.6 veal'),
(1, 3, 2, '300.6 verh', '300.6 verh'),
(1, 4, 2, '300.6 verh', '303.4 jage'),
(1, 5, 2, '303.4 wijsm', '305.6 inte'),
...
(1, 1, 4, '340.6 kraj', '340.9 buun'),
(1, 2, 4, '340.9 case', '340.9 pinc'),
(1, 3, 4, '340.9 rau', '341.6 bosw'),
(1, 4, 4, '341.6 evan', '345.0 broe'),
(1, 5, 4, '345.0 ewijk', '345.1 prin'),
(1, 1, 5, '345.1 soln', '345.7 onro'),
(1, 2, 5, '345.7 poll', '346.2 bela'),
(1, 3, 5, '346.2 bela', '351.3 luijk'),
(1, 4, 5, '351.3 meer', '354.0 hull'),
(1, 5, 5, '354.0 jage', '358.0 isaa'),
(2, 1, 1, '360.0 sluy', '360.6 heez'),
(2, 2, 1, '360.6 hull', '360.6 welt'),
(2, 3, 1, '360.8 cran', '360.9 vela'),
(2, 4, 1, '361.0 blak', '362.0 bel'),
(2, 5, 1, '362.0 berk', '362.0 dors'),
(2, 1, 2, '362.0 drur', '362.0 heez'),
(2, 2, 2, '362.0 hilt', '362.0 mult'),
(2, 3, 2, '362.0 nibe', '362.0 waal'),
(2, 4, 2, '362.0 wett', '362.0 wytz'),
(2, 5, 2, '362.1 wieb', '363.0 epe'),
(2, 1, 3, '363.0 exte', '364.0 chib'),
(2, 2, 3, '364.0 cbib', '366.0 chas'),
(2, 3, 3, '366.0 daws', '366.1 balo'),
(2, 4, 3, '366.1 berg', '366.1 cano'),
(2, 5, 3, '366.1 cial', '366.1 grit'),
(2, 1, 4, '366.1 hamm', '366.1 lind'),
(2, 2, 4, '366.1 loo', '366.1 pell'),
(2, 3, 4, '366.1 pijl', '366.1 webe'),
(2, 4, 4, '366.1 wegg', '366.2 laud'),
(2, 5, 4, '366.2 laud', '366.3 hoog'),
(2, 1, 5, '366.3 jans', '366.4 blom'),
(2, 2, 5, '366.4 bodd', '366.4 cove'),
(2, 3, 5, '366.4 crea', '366.4 dam'),
(2, 4, 5, '366.5 dam', '366.4 gels'),
